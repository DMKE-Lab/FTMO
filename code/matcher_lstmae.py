...
class EmbedMatcher_LSTMAE(nn.Module):
	...
	def forward(self, query, support, query_meta=None, support_meta=None):
		...
		# query_left_connections = query_meta
		# query_left_degrees = query_meta
		# query_right_connections = query_meta
		# query_right_degrees = query_meta
		support_left_connections, support_left_degrees, support_right_connections, support_right_degrees = support_meta
		# support_left_connections = support_meta
		# support_left_degrees = support_meta
		# support_right_connections = support_meta
		# support_right_degrees = support_meta
		# print(query_left_degrees,type(query_left_degrees))
		# print(type(query_left_degrees), type(query_left_connections))
		# print(query_left_degrees.shape, query_left_connections.shape)
		...
		# print(query_left.cpu().detach().numpy(),type(query_left.cpu().detach().numpy()))
		query_left = query_left.cpu().detach().numpy()
		query_left = torch.tensor(query_left[0:124])
		query_left = query_left.to(torch.device('cuda'))
		# print(len(aaa[0:100]))
		# print(query_left.size())
